...
public class MaintenanceController {
    ...
    public CreateMaintenanceResponse add(@RequestBody CreateMaintenanceRequest request) {
        return service.sendToMaintenance(request);
    }

    @PutMapping("/{id}")
    public UpdateMaintenanceResponse update( @RequestBody UpdateMaintenanceRequest request) {
        return service.updateMaintenanceStatus(request);
    }
